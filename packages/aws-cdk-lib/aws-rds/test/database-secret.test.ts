...
import { DEFAULT_PASSWORD_EXCLUDE_CHARS, DEFAULT_PASSWORD_LENGTH } from '../lib/private/util';
...
describe('database secret', () => {
  ...
  test('create a database secret with defined password length', () => {
    // GIVEN
    const stack = new Stack();
  ...
  test('replace on password critera change', () => {
    ...
    expect(dbSecretlogicalId).toEqual('Secret414c680e2707b4be512cb62a802b5977');
